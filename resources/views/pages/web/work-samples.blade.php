    ...
    <section>
        ...
        <div class="content-entry-box-A">
            <div>
                ...
                <p>
                    My last position was working in C#/.NET designing and building an asynchronous microservice architecture
                    using AWS services. Each microservice was truly independent and deployed on it's own with it's own repository.
                </p>
                <p>
                    I've also worked with the National Institutes of Health. They had a legacy
                    Cold Fusion application that they wanted to port over to PHP/Laravel for the front-end and Lumen for a database
