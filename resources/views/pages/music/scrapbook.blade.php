...
<section class="page-wrap">
    ...
    <section class="content-entry-box" id="moogfest2017">
        <h2>Moogfest 2017</h2>
        <p>
            <img alt="" class="image-left-25" src="http://media.clifjackson.net/images/SoC-moog-fest-2017/thumbs/TSOC-Logo-150w.jpg">While working at Oracle+Bronto I had a volunteer opportunity to co-lead the "Sounds Of Commerce" installation &mdash; a concept project to turn some of our tracking data
            in to music via MIDI. I wrote a blog post about that so I won't go into details here:<br>
        ...
        <p>
            What I <em>would</em> like to mention about it is how fun it was, what a great learning experience it was, and that I got to work with some really bright people who helped a lot with various aspects of the project! I may publish a YouTube video about how I designed and built the MIDI controllers seen below in the pictures.
        </p>
        <p>
            I took raw, anonymized tracking data and turned it into a variety of MIDI files. I handed that to my partner who then used Ableton Live to orchestrate an interactive audio-visual experience that people ended up having a lot of fun with!
        </p>
        <p>
            Additional links:<br>
