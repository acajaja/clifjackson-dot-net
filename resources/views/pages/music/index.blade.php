...
@section('content')
<div class="page-wrap">
    <a class="index-page-link" href="{{ route('music', ['page' => 'complete-discography']) }}" id="disco-link" title="My complete discography">
    ...
    <a class="index-page-link" href="{{ route('music', ['page' => 'audio']) }}" id="audio-link" title="Listen to my music">
    ...
    <a class="index-page-link" href="{{ route('music', ['page' => 'scrapbook']) }}" id="scrapbook-link" title="See my scrapbook">
    ...
    <a class="index-page-link" href="{{ route('music', ['page' => 'bass-player']) }}" id="bass-link" title="Recordings as a sideman">
    ...
    <a class="index-page-link" href="{{ route('music', ['page' => 'producer']) }}" id="producer-link" title="Recordings I've produced">
    ...
    <a class="index-page-link" href="{{ route('music', ['page' => 'player-producer']) }}" id="playprod-link" title="Recordings as both player & producer">
        <img class="button-image" alt="" src="http://media.clifjackson.net/images/roland-vs-880-ex-255857-240x240.jpg">
        <img class="circle-border" alt="" src="http://media.clifjackson.net/images/circle-5.png">
