    ...
    <section class="clearfix content-entry-box">
        ...
        <div class="content-entry-info-box zuk-box">
            <h2>Zük: An Evening in the Clouds</h2>
            <h3>October, 2005<br>CJ3 Music</h3>
            <p>
                A live recording of a session at Sky Bar in Buffalo, NY. This available as a FREE download. See the links on the left.
            ...
            <p><strong>Zük</strong><br>Personnel:<br>Zük - turntables</p>
            <p>
                Zük is a multi-talented musician and DJ. His DJ work centers mainly around deep house, but also includes elements of
                trip-hop, jazz and world music. Zük has worked with such greats as Juini Booth and Gregory Davis and was an integral
                part of Jazzopetry from the very beginning.
            </p>
        </div>
    </section>
